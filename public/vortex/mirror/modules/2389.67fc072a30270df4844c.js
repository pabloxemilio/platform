(self["webpackChunkfederation_modules"] = self["webpackChunkfederation_modules"] || []).push([[2389],{
...
function hasValidReactChildren(children) {
  ...
  return children.every(child => (0,compat_module.isValidElement)(child));
}
...
function nodesToString(children, i18nOptions) {
  ...
  childrenArray.forEach((child, childIndex) => {
    if (typeof child === 'string') {
      stringNode += `${child}`;
    } else if ((0,compat_module.isValidElement)(child)) {
...
function renderNodes(children, targetString, i18n, i18nOptions, combinedTOpts, shouldUnescape) {
  ...
  function getData(childs) {
    ...
    childrenArray.forEach(child => {
      ...
      if (hasChildren(child)) getData(getChildren(child));else if (typeof child === 'object' && !(0,compat_module.isValidElement)(child)) Object.assign(data, child);
    });
  }
  getData(children);
  ...
  function pushTranslatedJSX(child, inner, mem, i, isVoid) {
    ...
    mem.push((0,compat_module.cloneElement)(child, {
      ...child.props,
      key: i
  ...
  function mapAST(reactNode, astNode, rootReactNode) {
    ...
    return astNodes.reduce((mem, node, i) => {
      ...
      if (node.type === 'tag') {
        ...
        const isElement = (0,compat_module.isValidElement)(child);
        ...
        if (typeof child === 'string') {
          ...
          if (isKnownComponent) {
            ...
            if (node.voidElement) {
              mem.push((0,compat_module.createElement)(node.name, {
                key: `${node.name}-${i}`
              }));
            } else {
              const inner = mapAST(reactNodes, node.children, rootReactNode);
        ...
        if (wrapTextNodes) {
          mem.push((0,compat_module.createElement)(wrapTextNodes, {
            key: `${node.name}-${i}`
          }, content));
        } else {
          mem.push(content);
...
function Trans(_ref) {
  ...
  return useAsParent ? (0,compat_module.createElement)(useAsParent, additionalProps, content) : content;
}
...
const I18nContext = (0,compat_module.createContext)();
...
function Trans_Trans(_ref) {
  ...
  } = (0,compat_module.useContext)(I18nContext) || {};
...
function useTranslation(ns) {
  ...
  const [t, setT] = (0,compat_module.useState)(getT);
  let joinedNS = namespaces.join();
  if (props.lng) joinedNS = `${props.lng}${joinedNS}`;
  const previousJoinedNS = usePrevious(joinedNS);
  const isMounted = (0,compat_module.useRef)(true);
  (0,compat_module.useEffect)(() => {
    const {
      bindI18n,
      bindI18nStore
  ...
  const isInitial = (0,compat_module.useRef)(true);
  (0,compat_module.useEffect)(() => {
...
function withTranslation(ns) {
  ...
  return function Extend(WrappedComponent) {
    function I18nextWithTranslation(_ref) {
      ...
      return (0,compat_module.createElement)(WrappedComponent, passDownProps);
    }
    I18nextWithTranslation.displayName = `withI18nextTranslation(${getDisplayName(WrappedComponent)})`;
    I18nextWithTranslation.WrappedComponent = WrappedComponent;
    const forwardRef = (props, ref) => (0,compat_module.createElement)(I18nextWithTranslation, Object.assign({}, props, {
      forwardedRef: ref
    }));
    return options.withRef ? (0,compat_module.forwardRef)(forwardRef) : I18nextWithTranslation;
  };
}
...
function I18nextProvider(_ref) {
  ...
  const value = (0,compat_module.useMemo)(() => ({
    i18n,
    defaultNS
  }), [i18n, defaultNS]);
  return (0,compat_module.createElement)(I18nContext.Provider, {
    value
  }, children);
}
...
function withSSR() {
  return function Extend(WrappedComponent) {
    function I18nextWithSSR(_ref) {
      ...
      return (0,compat_module.createElement)(WrappedComponent, {
        ...rest
      });
    }
