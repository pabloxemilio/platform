"use strict";
(self["webpackChunkfederation_modules"] = self["webpackChunkfederation_modules"] || []).push([[8075],{
...
__webpack_require__.d(__webpack_exports__, {
  componentsToDebugString: () => (/* binding */ componentsToDebugString),
  "default": () => (/* binding */ index),
  getFullscreenElement: () => (/* binding */ getFullscreenElement),
  getUnstableAudioFingerprint: () => (/* binding */ getUnstableAudioFingerprint),
  getUnstableCanvasFingerprint: () => (/* binding */ getUnstableCanvasFingerprint),
  getUnstableScreenFrame: () => (/* binding */ getUnstableScreenFrame),
  getUnstableScreenResolution: () => (/* binding */ getUnstableScreenResolution),
  getWebGLContext: () => (/* binding */ getWebGLContext),
  hashComponents: () => (/* binding */ hashComponents),
  isAndroid: () => (/* binding */ isAndroid),
  isChromium: () => (/* binding */ isChromium),
  isDesktopWebKit: () => (/* binding */ isDesktopWebKit),
  isEdgeHTML: () => (/* binding */ isEdgeHTML),
  isGecko: () => (/* binding */ isGecko),
  isSamsungInternet: () => (/* binding */ isSamsungInternet),
  isTrident: () => (/* binding */ isTrident),
  isWebKit: () => (/* binding */ isWebKit),
  load: () => (/* binding */ load),
  loadSources: () => (/* binding */ loadSources),
  murmurX64Hash128: () => (/* binding */ murmurX64Hash128),
  prepareForSources: () => (/* binding */ prepareForSources),
  sources: () => (/* binding */ sources),
  transformSource: () => (/* binding */ transformSource),
  withIframe: () => (/* binding */ withIframe)
});
